      ...
      <div className="flex items-center">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="h-9 w-64 rounded-md border border-slate-200 bg-slate-50 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
      </div>
